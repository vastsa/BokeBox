...
本文面向插件作者。系统总览见 [Source 插件总览](../plugins/source.md)，可运行示例见 [examples/source-plugin-echo](https://github.com/vastsa/BokeBox/tree/main/examples/source-plugin-echo)。
...
- 架构说明：[Source 插件总览](../plugins/source.md)  
