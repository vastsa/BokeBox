...
> **写插件？** 请直接看开发规范： [Source 插件开发](../development/source-plugin.md)
...
- 开发规范： [Source 插件开发](../development/source-plugin.md)
- 示例插件： [`examples/source-plugin-echo/`](https://github.com/vastsa/BokeBox/tree/main/examples/source-plugin-echo)
