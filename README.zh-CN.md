...
- ASR/TTS 插件说明： [docs/asr-tts-plugins.md](./docs/asr-tts-plugins.md)
- TTS 插件开发： [docs/tts-plugin-development.md](./docs/tts-plugin-development.md)
- TTS 示例： [examples/tts-plugin-echo](./examples/tts-plugin-echo) · [examples/tts-plugin-fishspeech](./examples/tts-plugin-fishspeech)
- 前端 Token（字号/颜色）： [docs/web-design-tokens.md](./docs/web-design-tokens.md)
...
完整变量见 `.env.example`。CI/CD 与镜像发布见 [`docs/ci-cd.md`](docs/ci-cd.md)。Web 字号/颜色 Token 规范见 [`docs/web-design-tokens.md`](docs/web-design-tokens.md)。
